...
Select `Add a README file` box and click on the green `Create Repository` button

![](fig\gh_new-repo-publish.png){alt="GitHub create a new repo README and publish button"}
...
If we now visit `https://aymanbx.github.io/my-website/`,

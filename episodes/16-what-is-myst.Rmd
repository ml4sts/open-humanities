...
Today is when everything we've learned come together into on.
- We've talked about GitHub
- We've seen GitHub pages do magic
- We got intorduced to the shell of our operating systems
- And we've learned how to do different tricks over the shell
...
If code doesn't work (problems with path) just open vscode manually

...
```output
total 0
drwx------+  6 humanist  staff   204 Jul 16 11:50 Desktop
drwx------+  3 humanist  staff   102 Jul 16 11:30 Documents
drwx------+  3 humanist  staff   102 Jul 16 11:30 Downloads
drwx------@ 46 humanist  staff  1564 Jul 16 11:38 Library
drwx------+  3 humanist  staff   102 Jul 16 11:30 Movies
drwx------+  3 humanist  staff   102 Jul 16 11:30 Music
drwx------+  3 humanist  staff   102 Jul 16 11:30 Pictures
drwxr-xr-x+  5 humanist  staff   170 Jul 16 11:30 Public
```
...
Now `ls -h` won't work on its own. When we want to combine two flags, we can just run them together. To do so, we can either run then as so `ls -l -h` or combine them as so `ls -lh`
So, by typing `ls -lh` and pressing enter we receive an output in a human-readable format (note: the order here doesn't matter).
...
```output
total 0
drwx------+  6 humanist  staff   204B Jul 16 11:50 Desktop
drwx------+  3 humanist  staff   102B Jul 16 11:30 Documents
drwx------+  3 humanist  staff   102B Jul 16 11:30 Downloads
drwx------@ 46 humanist  staff   1.5K Jul 16 11:38 Library
drwx------+  3 humanist  staff   102B Jul 16 11:30 Movies
drwx------+  3 humanist  staff   102B Jul 16 11:30 Music
drwx------+  3 humanist  staff   102B Jul 16 11:30 Pictures
drwxr-xr-x+  5 humanist  staff   170B Jul 16 11:30 Public
```
...
:::::::::::: callout
Here, we need to make a quick observation to distinguish between two terms that are very different:
...
Whereas **options** modify the workings of the command by telling the computer what sort of output or manipulation we want. Options are denoted by one or two hyphens `-`, `--`.
::::::::::::

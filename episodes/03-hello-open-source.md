...
After successfully uploading the file it can be found in the list of files of your repo. Click on it to open it and then click on the edit button on the top of the file.  
Rename the file to `index.md` then commit the changes again.  
...
1. Go to [https://github.com/some-humanist/my-website](), where "some-humanist" is the username of your exercise partner.

1. Find the website link in their about section of their repo and open it.

1. Scroll to the bottom of their webpage and find the button that says `improve this page`.

1. Click on `Fork this repository`. This takes you to a file editor that edits your partner's article.

1. Now is good chance to try some Markdown syntax.
...
1. Once you are ready to commit, enter a short commit message,
...
1. You can now go to the repository on your account and click "New Pull Request" button,
...
1. Your partner should now see a pull request under the "Pull requests" tab
